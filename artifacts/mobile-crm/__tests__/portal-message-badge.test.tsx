/**
 * Guards the mobile lead timeline's "Homeowner message" treatment: activities
 * of type `portal_message` render an amber badge (matching the Command Center
 * highlight), while other activity types do not.
 */
...
describe('lead timeline portal-message treatment', () => {
  it('shows the Homeowner message badge for portal_message activities', () => {
    ...
    expect(screen.getByText('Homeowner message')).toBeTruthy();
    expect(screen.getByTestId('portal-message-activity-act-portal')).toBeTruthy();
  });
